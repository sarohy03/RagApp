...
function SignupPage() {
  ...
  return (
    ...
    <div className="bg-slate-200 min-h-screen flex flex-col overflow-hidden box-border">
      ...
      <div className="animate-moveFromRight lg:animate-moveToRight">
      ...
      <div className="flex flex-col lg:flex-row-reverse z-10 relative w-full mt-[10%]">


        {/* right section for sign-up prompt */}
        ...
        <div className="flex-1 p-4 flex items-center justify-center animate-moveFromRight">
